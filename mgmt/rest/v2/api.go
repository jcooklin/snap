...
func (s *apiV2) GetRoutes() []api.Route {
	routes := []api.Route{
		...
		// Load
		//
		// TODO: describe what needs to be in the formData
		//
		// Consumes:
		// application/json
		// application/x-protobuf
		...
		// Get Config
		//
		// Optional fields are plugin type, name and version.
		//
		// Consumes:
		// application/json
		// application/x-protobuf
		...
		// Delete Config
		//
		// Optional fields include plugin type, name and version.  Note that
